                    ...
                    <div class="">
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{ asset('dashboard/images/products/05.png') }}" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="my-2">iPhone 11 - A24512 <span class="float-end">(4,216
                                            Orders) <span class="ms-3 fw-bold">42%</span></span></p>
                        ...
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{ asset('dashboard/images/products/07.png') }}" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="my-2">iPhone 11 - A24512 <span class="float-end">(4,216
                        ...
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{ asset('dashboard/images/products/09.png') }}" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="my-2">iPhone 11 - A24512 <span class="float-end">(4,216
                        ...
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{ asset('dashboard/images/products/02.png') }}" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="my-2">iPhone 11 - A24512 <span class="float-end">(4,216
                        ...
                        <div class="d-flex align-items-start gap-3">
                            <div class="product-box border">
                                <img src="{{ asset('dashboard/images/products/04.png') }}" alt="product img">
                            </div>
                            <div class="flex-grow-1">
                                <div class="progress-wrapper">
                                    <p class="my-2">iPhone 11 - A24512 <span class="float-end">(4,216
                    ...
                    <div class="review-list">
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{ asset('dashboard/images/avatars/avatar-1.png') }}" width="65"
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{ asset('dashboard/images/avatars/avatar-2.png') }}" width="65"
                                    height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{ asset('dashboard/images/avatars/avatar-3.png') }}" width="65"
                                    height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{ asset('dashboard/images/avatars/avatar-4.png') }}" width="65"
                                    height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{ asset('dashboard/images/avatars/avatar-5.png') }}" width="65"
                                    height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{ asset('dashboard/images/avatars/avatar-6.png') }}" width="65"
                                    height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
                        ...
                        <div class="d-flex align-items-start">
                            <div class="review-user">
                                <img src="{{ asset('dashboard/images/avatars/avatar-7.png') }}" width="65"
                                    height="65" class="rounded-circle" alt="">
                            </div>
                            <div class="review-content ms-3">
                                <div class="rates cursor-pointer fs-6">
